...
class KategorienListAdapter(
    private val myKategorien: List<Kategorie>,
    private val iconArray: Array<Int>
) : RecyclerView.Adapter<KategorienListAdapter.KategorienViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): KategorienListAdapter.KategorienViewHolder {

        val layoutInflater = LayoutInflater.from(parent.context)
        val mItemView =
            layoutInflater.inflate(
                R.layout.fragment_kategorien_recycler_text_view,
                parent,
                false)
        // mItemView ist nun die jeweilige View
        // auf das ConstraintLayout der Items in der Recyclerview
    ...
    inner class KategorienViewHolder(val mItemView: View) : RecyclerView.ViewHolder(mItemView),
